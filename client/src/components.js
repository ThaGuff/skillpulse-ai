...
// ── App shell — fills the full viewport, mobile-first ──────────────────────
export function AppShell({ children }) {
  return (
    <div style={{
      ...
      {/* Phone-width column with ambient glow */}
      <div style={{
        position: 'relative',
        width: '100%',
        maxWidth: 430,
        ...
        <div style={{
          ...
          background: `radial-gradient(ellipse, rgba(0,232,122,0.14) 0%, transparent 70%)`,
  ...
  return (
    <div style={{ padding: '12px 24px 0', flexShrink: 0 }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 7 }}>
        <span style={{ fontSize: 11, color: C.muted, letterSpacing: '0.07em', fontWeight: 500 }}>
          STEP {step} OF {total}
        </span>
  ...
  return (
    <button
      ...
      style={{
        ...
        textAlign: 'left',
        cursor: 'pointer',
        background: selected ? C.accentLow : C.card,
  ...
  return (
    <button
      ...
      style={{
        ...
        background: disabled || loading ? C.border : C.accent,
        color: disabled || loading ? C.muted : '#051008',
...
export function MetricCard({ label, value, sub, color }) {
  return (
    <div style={{
      ...
      <div style={{ fontSize: 24, fontWeight: 800, color: color || C.text, lineHeight: 1, fontFamily: 'Syne, sans-serif' }}>
        {value}
      </div>
